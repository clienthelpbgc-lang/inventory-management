...
/** Days since last use at which a tenant drops to the next status. */
...
> = {
  [TENANT_USAGE_STATUS.ACTIVE]: {
    label: "Active",
    description: `Used in the last ${ACTIVE_WITHIN_DAYS} days`,
    className: "bg-emerald-50 text-emerald-700 border-emerald-200",
  },
  [TENANT_USAGE_STATUS.LOW_USAGE]: {
    label: "Low usage",
    description: `Last used ${ACTIVE_WITHIN_DAYS}–${LOW_USAGE_WITHIN_DAYS} days ago`,
    className: "bg-amber-50 text-amber-700 border-amber-200",
  },
  [TENANT_USAGE_STATUS.INACTIVE]: {
    label: "Inactive",
    description: `Not used for over ${LOW_USAGE_WITHIN_DAYS} days`,
    className: "bg-red-50 text-red-700 border-red-200",
  },
  [TENANT_USAGE_STATUS.NEVER_USED]: {
    label: "Never used",
    description: "No one has signed in since onboarding",
